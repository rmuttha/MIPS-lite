...
current_ins_count = 0				# To keep a track of current instruction count for detecting hazards 
    ...
    if(current_ins_count == 0):
        ...
        if(((fetch_instruction[current_ins_count] >> 26) & 63) in REG_REG_INS):
            if(((fetch_instruction[current_ins_count-1] >> 26) & 63) in R_TYPE):
                if((((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-1] >> 11) & 31)) or (((fetch_instruction[current_ins_count] >> 16) & 31) == ((fetch_instruction[current_ins_count-1] >> 11) & 31))):
                    total_stalls += 2
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
            elif(((fetch_instruction[current_ins_count-1] >> 26) & 63) in I_TYPE or ((fetch_instruction[current_ins_count-1] >> 26) & 63) == LDW):
                if((((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-1] >> 16) & 31)) or (((fetch_instruction[current_ins_count] >> 16) & 31) == ((fetch_instruction[current_ins_count-1] >> 16) & 31))):
                    total_stalls += 2
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
            ...
            if(((fetch_instruction[current_ins_count-1] >> 26) & 63) in R_TYPE):
                if(((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-1] >> 11) & 31)):
                    total_stalls += 2
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
            elif(((fetch_instruction[current_ins_count-1] >> 26) & 63) in I_TYPE or ((fetch_instruction[current_ins_count-1] >> 26) & 63) == LDW):
                if(((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-1] >> 16) & 31)):
                    total_stalls += 2
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return                                        
        ...
        if(((fetch_instruction[current_ins_count-1] >> 26) & 63) in branch_flag):
            ...
            if((current_ins_count-1) in stalls_list):
                ...
                if((((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-2] >> 11) & 31)) or (((fetch_instruction[current_ins_count] >> 16) & 31) == ((fetch_instruction[current_ins_count-2] >> 11) & 31))):
                    total_stalls += 1
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
            elif(((fetch_instruction[current_ins_count-2] >> 26) & 63) in I_TYPE or ((fetch_instruction[current_ins_count-2] >> 26) & 63) == LDW):
                if((((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-2] >> 16) & 31)) or (((fetch_instruction[current_ins_count] >> 16) & 31) == ((fetch_instruction[current_ins_count-2] >> 16) & 31))):
                    total_stalls += 1
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
            ...
            if(fetch_instruction[current_ins_count-1] in stalls_list):
                ...
                if(((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-2] >> 11) & 31)):
                    total_stalls += 1
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
            elif(((fetch_instruction[current_ins_count-2] >> 26) & 63) in I_TYPE or ((fetch_instruction[current_ins_count-2] >> 26) & 63) == LDW):
                if(((fetch_instruction[current_ins_count] >> 21) & 31) == ((fetch_instruction[current_ins_count-2] >> 16) & 31)):
                    total_stalls += 1
                    total_hazards += 1
                    stalls_list.append(fetch_instruction[current_ins_count])
                    return
